    ...
    <div className='projects'>
        ...
        <div className='project-container'>
            ...
            <div className='project-row' id='dissertations'>
                ...
                <Project title="Cricket Predictor" image="/images/ProjectImages/Cricket.png" readme="For my 3rd year dissertation
                ...
                this day." github={true} githubLink="//github.com/JohnSteward/CricketML" pdf={true} pdfLink="/Reports/Cricket-Report.pdf"/>
            
            </div>
            <h1 className='project-title'>Other Projects</h1>
            <div className='project-row' id='row-1'>
                <Project title="Bayesian Machine Learning" image="/images/ProjectImages/Bayesian-Image.png" readme="For this project,
                ...
                which to sample." github={true} githubLink="//github.com/JohnSteward/Bayesian" pdf={true} 
                pdfLink="/Reports/Bayesian-Report.pdf" />
                
                <Project title="Natural Language Processing" image="/images/ProjectImages/NLP-Matrix.png" readme="This project was a full
                    ...
                    github={true} githubLink="//github.com/JohnSteward/NLP-Coursework" pdf={true} pdfLink="/Reports/NLP_Report.pdf"/>
                <Project title="Computer Vision" image="/images/ProjectImages/Vision.png" readme="For this group project, there were
                ...
                invariance to rotation." pdf={true} pdfLink="/Reports/Vision-Report.pdf" github={false} />
                
            </div>

            <div className='project-row' id='row-2'>
                <Project title="Chrome Extension for Social Media" image="/images/ProjectImages/ESP.png" readme="This group project
                ...
                <Project title="Ray-Tracer C++" image="/images/ProjectImages/Graphics-Image.png" readme="For this project, I implemented
                ...
                pdf={true} pdfLink="/Reports/Graphics-Report.pdf"/>

                <Project title="Productivity Web App" image="/images/ProjectImages/SPaM.png" readme="This was a group web app project focussed on tracking each 
                ...
                pdf={true} pdfLink="/Reports/SPaM-Report.pdf" />
            </div>
            <div className='project-row' id='row-3'>
                <Project title="Python Turn-Based RPG (Pygame)" image="/images/ProjectImages/A-Level.png" readme="For my A-level
                ...
                different spells." github={true} githubLink="//github.com/JohnSteward/ALevelProject" pdf={true} 
                pdfLink="/Reports/A-Level-Project.pdf" />

                <Project title="Java Chat Server" image="/images/ProjectImages/chat-server.png" readme="For this project,
                    ...
                    githubLink="//github.com/JohnSteward/Chat-Server" />

                <Project title="Visual Computing (WebGL)" image="/images/ProjectImages/WebGL.png" readme="For this project, there
                    ...
                    animation with a smaller angle of rotation being applied more times." github={true} githubLink="//github.com/JohnSteward/WebGL" pdf={true} pdfLink="/Reports/Visual-Report.pdf"/>
            </div>
        </div>
        <div className='project-row' id='row-4'>
            <Project title="Dungeon of Doom" image="/images/ProjectImages/DoD.png" readme="For this project, I created a text-based
                ...
                in size." github={true} githubLink="//github.com/JohnSteward/Dungeon-of-Doom" />
            
            <Project title="SRPN Calculator" image="/images/ProjectImages/srpn.png" readme="For this project, I made a Python
            ...
            to output the desired result." github={true} githubLink="//github.com/JohnSteward/SRPN" />
        </div>
